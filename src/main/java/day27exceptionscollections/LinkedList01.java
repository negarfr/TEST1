...
/*
        ...
        Collections are for store N0N-Primitive date type, which mean you can not store Primitive Data for this you can use Arrays
...
import java.util.LinkedList;
    ...
    public class LinkedList01 {
        ...
        public static void main(String[] args) {
            ...
            // Example 2: if the number of Characters is more than 4, remove them from the link
