...
public class E03 {
    ...
    /*
       ...
       i- "Exception" can be handled but error not
       ii- OutOfMemory, StackOutOfMemory, VirtualMachine, Assertion can be example for errors.
     */
    ...
    //create a method to read a text from text file
    // if the path is wrong, if the file does not exist, if the text can not read stop execution
    ...
    //create a method to read a text from text file
    // if the path is wrong, give the message to the user and do not stop execution
    // if the file does not exist, give the message to the user and do not stop execution
    // if the text can not read stop execution, give the message to the user and do not stop execution
